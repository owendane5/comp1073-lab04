...
// TEXZ32wkvuHaCIzcs7gXxAiCpYz5DNH9xqiMPThY
...
const user = "TEXZ32wkvuHaCIzcs7gXxAiCpYz5DNH9xqiMPThY";
...
const lightSwitchOn = document.getElementById('on');
const lightSwitchOff = document.getElementById('off');
const brightness = document.querySelector("select");
const half = document.getElementById("full");
const full = document.getElementById("half");
...
lightSwitchOn.addEventListener("click", function(){
	var commands = '{ "on" : true }';
	updateLight(commands);
})
lightSwitchOff.addEventListener("click", function(){
	var commands = '{ "on" : false }';
	updateLight(commands);
})
brightness.addEventListener("change", function(){
	if (brightness[0] = true){
		var commands = '{ "bri" : 120 }';
		updateLight(commands);
	} else
	var commands = '{ "bri" : 240 }';
		updateLight(commands);
